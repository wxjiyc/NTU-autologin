...
case $ch1 in
    [yY][eE][sS] | [yY])
        ...
        case $ch2 in
            ...
            echo '        curl "http://210.29.79.141:801/eportal/?c=Portal&a=login&callback=dr1003&login_method=1&user_account=%2C0%2C$1%40$3&user_password=$2&wlan_user_ip=$local_ip&wlan_user_ipv6=&wlan_user_mac=000000000000&wlan_ac_ip=&wlan_ac_name=&jsVersion=3.3.2&v=5992"' >>autologin.sh
